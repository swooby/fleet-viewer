...
namespace RTEditor
{
    public class InputDeviceGvrController : InputDeviceAbstract
    {
        ...
        /// Code basically pulled from DaydreamElements/Elements/ClickMenu/Demo/Scripts/Painter.cs
        /// </summary>
        ...
        private static Vector3 GetLaserPointerEndpoint(GvrLaserPointer laserPointer)
        {
            ...
            if (laserPointer != null)
            {
                ...
                //GLPrimitives.Draw3DLine(ray.origin, ray.origin + (ray.direction * 10), Color.magenta, MaterialPool.Instance.GLLine);
                //Debug.LogWarning("laserPointerEndPoint:" + laserPointerEndPoint);
                //Vector3 laserPointerEndPoint2 = laserPointer.transform.InverseTransformPoint(laserPointerEndPoint);
                //Debug.LogWarning("laserPointerEndPoint2:" + laserPointerEndPoint2);
            }
        ...
        public override bool GetPickRay(Camera camera, out Ray ray)
        {
            ...
            if (GetPosition(out laserPointerEndPoint))
            {
                ...
                //Debug.DrawRay(ray.origin, ray.direction, Color.cyan, 0, false);
                return true;
            }
